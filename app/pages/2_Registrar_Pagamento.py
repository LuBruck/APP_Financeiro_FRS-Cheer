...
st.caption("Mensalidades — cobranças individuais por membro/mês.")
...
if submitted:
    ...
    # Se a linha não existia, cria agora (aproveita geração lazy sob demanda).
    if pagamento is None:
    ...
    # Limpa query params para não re-selecionar no próximo rerun.
